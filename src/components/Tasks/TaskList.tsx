...
import { Plus, Check, Trash2, Target, ChevronUp, ChevronDown, Flag } from 'lucide-react'
...
function TaskItem({ task, onSetActive }: { task: Task; onSetActive: () => void }) {
...
export function TaskList() {
  const { tasks, addTask, activeTaskId, setActiveTask } = useTaskStore()
